                ...
                @forelse ($vacantes as $vacante)
                    <div class="md:flex md:justify-between md:items-center py-5">
                        <div class="md:flex-1">
                            ...
                            <p class="text-base text-gra-600 mb-1" > {{$vacante->empresa}}</p>
                            <p class="text-xs font-bold text-gra-600 mb-1" > {{$vacante->categoria->categoria}}</p>
                            <p class="text-base text-gra-600 mb-1" > {{$vacante->salario->salario}}</p>
                        ...
                        <div class="mt-5 md:mt-0">
                            <a 
                                class="text-sm p-3 uppercase font-bold rounded-lg bg-indigo-500 text-white block text-center"
